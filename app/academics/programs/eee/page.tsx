...
const learningOutcomes = [
  ...
  'Understanding of power systems and automation',
  'Ability to design renewable and smart grid solutions',
  'Problem-solving skills for real-world electrical challenges',
];
...
const industryLabs = [
  { name: 'Siemens Automation Lab', focus: 'Industrial automation and smart grids' },
  { name: 'ABB Power Lab', focus: 'Advanced power systems and renewable energy' },
];

const peos = [
  'PEO1: Technical Excellence — Apply strong foundational and advanced knowledge in electrical and electronics engineering to solve complex engineering problems.',
  'PEO2: Professional Success — Build successful careers as engineers, team members, or leaders in EEE and related industries.',
...
const psos = [
  'PSO1: Design and analyze electrical circuits and power systems.',
  'PSO2: Develop automation and renewable energy solutions for real-world applications.',
];
...
const innovativePractices = [
  ...
  'Hands-on workshops in automation and smart grids.',
...
const professionalDevelopmentHighlights = [
  {
    ...
    detail: 'Annual FDPs on automation, power systems, and renewable energy with industry experts.',
  },
  {
...
const photoGallery = [
  {
    ...
    description: 'EEE faculty prototyping automation tools with industry mentors.',
  },
  {
    src: '/images/programs/eee/StudentInnovationShowcaseeee.jpeg',
    title: 'Student Innovation Showcase',
    description: 'EEE teams demo capstone prototypes and smart grid dashboards to reviewers.',
  },
  {
    src: '/images/programs/eee/ImmersiveLabPracticeeee.jpeg',
    title: 'Immersive Lab Practice',
    description: 'Students collaborate in the Siemens Automation Lab.',
  },
  {
...
const academicCalendars = [
  {
    ...
    file: '/images/programs/eee/31AcademicCalendar.pdf',
  },
  {
    label: '2nd Year 1st Semester',
    file: '/images/programs/eee/21AcademicCalendar.pdf',
  },
];
      ...
      <div className="mx-auto w-full max-w-[95rem] px-4 sm:px-6 lg:px-8 pt-16 pb-12 space-y-12 md:pt-20">
        <header className="relative overflow-hidden rounded-[40px] bg-gradient-to-br from-corporate-navy via-corporate-blue to-sky-400 px-8 py-12 text-white shadow-[0_35px_80px_-40px_rgba(15,23,42,0.9)]">
          ...
          <div className="relative z-10 flex flex-col gap-10 lg:flex-row lg:items-center">
            <div className="flex-1 space-y-6">
              <div>
                <p className="uppercase tracking-[0.4em] text-[11px] text-white/70">Department of EEE</p>
                <h1 className="text-[2rem] md:text-[2.75rem] font-black mt-3 drop-shadow-lg">Electrical &amp; Electronics Engineering</h1>
                <p className="text-lg text-white/90 mt-4">Building the future of electrical and automation technology</p>
              </div>
              <p className="text-white/85 max-w-2xl leading-relaxed">
                Future-ready curriculum, outcome-based learning, and partnerships with leading technology companies empower NSRIET EEE students to
        ...
        <div className="flex flex-col lg:flex-row gap-10 items-start">
          ...
          <div className="flex-1 w-full space-y-12">
            <EEESection id="eee-home" title="Program Overview">
              <div className="space-y-5 text-gray-600 dark:text-gray-300">
                <p>
                  The Electrical &amp; Electronics Engineering program at NSRIET is designed to develop skilled professionals who can solve
                  real-world electrical and automation problems. Students gain expertise in circuit design, power systems, and automation technologies while
            ...
            <EEESection id="vision-mission" title="Vision &amp; Mission">
              <div className="grid md:grid-cols-2 gap-6">
                <div className="p-6 rounded-2xl bg-blue-50 dark:bg-blue-900/30">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    To develop students as skilled electrical and automation professionals ready to excel in industry, research, and contribute meaningfully to society.
                  </p>
                </div>
                <div className="p-6 rounded-2xl bg-blue-50 dark:bg-blue-900/30">
                  ...
                  <ul className="space-y-2 text-gray-600 dark:text-gray-300 list-disc list-inside">
                    <li>
                      ...
                      Provide comprehensive knowledge in electrical and automation fundamentals and advanced concepts through effective teaching methods, with strong emphasis on practical skills.
                    </li>
                    <li>
            ...
            <EEESection id="peos" title="Program Educational Objectives (PEOs)">
            ...
            <EEESection id="pos-psos" title="Program Outcomes (POs) &amp; PSOs">
            ...
            <EEESection id="curriculum" title="Curriculum Highlights &amp; Syllabi">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                Outcome-based curriculum covering core electrical, emerging tech electives, and interdisciplinary pathways. Download the detailed syllabus and course outcomes below.
              </p>
              <div className="flex flex-wrap gap-3">
                <Link
                  href="/images/programs/eee/EEE%20Course%20Structure%20%26%20Syllabus-%20B.Tech%20EEE.pdf"
                  target="_blank"
            ...
            <EEESection id="academic-calendar" title="Academic Calendar">
              <p className="text-gray-600 dark:text-gray-300 mb-4">
            ...
            <EEESection id="laboratories" title="Laboratories">
              <div className="grid md:grid-cols-2 gap-4">
                {labs.map((lab) => (
            ...
            <EEESection id="industry-lab" title="Industry Sponsored Laboratory">
            ...
            <EEESection id="mous" title="Memoranda of Understanding (MoUs)">
              <div className="flex flex-wrap gap-3">
            ...
            <EEESection id="innovative-teaching" title="Innovative Teaching Methodologies">
            ...
            <EEESection id="professional-development" title="Professional Development Activities">
            ...
            <EEESection id="photo-gallery" title="Photo Gallery">
...
type EEESectionProps = {
  id: string;
  title: string;
  children: ReactNode;
};

function EEESection({ id, title, children }: EEESectionProps) {
  return (
    <section
      id={id}
