...
const heroHighlights = [
  ...
  'Experiential learning through case studies & projects',
...
const learningOutcomes = [
  'Proficiency in business analysis and decision-making',
  'Understanding of management principles and leadership',
  'Ability to use analytical tools for business solutions',
  'Problem-solving skills for real-world business challenges',
];
...
const industryLabs = [
  { name: 'Deloitte Business Simulation Lab', focus: 'Business analytics and simulation' },
  { name: 'ICICI Learning Lab', focus: 'Finance and banking operations' },
];

const peos = [
  'PEO1: Managerial Excellence — Apply strong foundational and advanced knowledge in management to solve complex business problems.',
  'PEO2: Professional Success — Build successful careers as managers, entrepreneurs, or leaders in business and related industries.',
...
const psos = [
  'PSO1: Analyze and solve business problems using management principles.',
  'PSO2: Develop entrepreneurial and leadership skills for real-world applications.',
];
...
const innovativePractices = [
  'Case-based learning with industry mentors.',
  'Hands-on workshops in analytics and entrepreneurship.',
...
const professionalDevelopmentHighlights = [
  {
    ...
    detail: 'Annual FDPs on business analytics, entrepreneurship, and management with industry experts.',
  },
  {
    title: 'Industry Case Sprints',
    detail: 'Immersive sprints where students solve real business cases for partner companies.',
  },
  {
    title: 'Innovation Showcases',
    detail: 'Showcases featuring student projects, business plans, and industry feedback.',
  },
  {
...
const photoGallery = [
  {
    ...
    description: 'MBA faculty conducting business simulations with industry mentors.',
  },
  {
    src: '/images/programs/mba/StudentInnovationShowcaseMBA.jpeg',
    title: 'Student Innovation Showcase',
    description: 'MBA teams demo capstone business plans and analytics dashboards to reviewers.',
  },
  {
    src: '/images/programs/mba/ImmersiveLabPracticeMBA.jpeg',
    title: 'Immersive Lab Practice',
    description: 'Students collaborate in the Deloitte Business Simulation Lab.',
  },
  {
...
const academicCalendars = [
  {
    ...
    file: '/images/programs/mba/11AcademicCalendar.pdf',
  },
  {
    label: '2nd Year 1st Semester',
    file: '/images/programs/mba/21AcademicCalendar.pdf',
  },
];
      ...
      <div className="mx-auto w-full max-w-[95rem] px-4 sm:px-6 lg:px-8 pt-16 pb-12 space-y-12 md:pt-20">
        <header className="relative overflow-hidden rounded-[40px] bg-gradient-to-br from-corporate-navy via-corporate-blue to-sky-400 px-8 py-12 text-white shadow-[0_35px_80px_-40px_rgba(15,23,42,0.9)]">
          ...
          <div className="relative z-10 flex flex-col gap-10 lg:flex-row lg:items-center">
            <div className="flex-1 space-y-6">
              <div>
                <p className="uppercase tracking-[0.4em] text-[11px] text-white/70">Department of MBA</p>
                <h1 className="text-[2rem] md:text-[2.75rem] font-black mt-3 drop-shadow-lg">Master of Business Administration</h1>
                <p className="text-lg text-white/90 mt-4">Empowering future business leaders and entrepreneurs</p>
              </div>
              <p className="text-white/85 max-w-2xl leading-relaxed">
                Future-ready curriculum, outcome-based learning, and partnerships with leading companies empower NSRIET MBA students to
                innovate confidently and lead the next wave of business transformation.
              </p>
        ...
        <div className="flex flex-col lg:flex-row gap-10 items-start">
          ...
          <div className="flex-1 w-full space-y-12">
            <MBASection id="mba-home" title="Program Overview">
              <div className="space-y-5 text-gray-600 dark:text-gray-300">
                <p>
                  The MBA program at NSRIET is designed to develop skilled professionals who can solve
                  real-world business and management problems. Students gain expertise in business analysis, leadership, and entrepreneurship while
            ...
            <MBASection id="vision-mission" title="Vision &amp; Mission">
              <div className="grid md:grid-cols-2 gap-6">
                <div className="p-6 rounded-2xl bg-blue-50 dark:bg-blue-900/30">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    To develop students as skilled business professionals ready to excel in industry, research, and contribute meaningfully to society.
                  </p>
                </div>
                <div className="p-6 rounded-2xl bg-blue-50 dark:bg-blue-900/30">
                  ...
                  <ul className="space-y-2 text-gray-600 dark:text-gray-300 list-disc list-inside">
                    <li>
                      ...
                      Provide comprehensive knowledge in management fundamentals and advanced concepts through effective teaching methods, with strong emphasis on practical skills.
                    </li>
                    <li>
            ...
            <MBASection id="peos" title="Program Educational Objectives (PEOs)">
            ...
            <MBASection id="pos-psos" title="Program Outcomes (POs) &amp; PSOs">
            ...
            <MBASection id="curriculum" title="Curriculum Highlights &amp; Syllabi">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                Outcome-based curriculum covering core management, emerging tech electives, and interdisciplinary pathways. Download the detailed syllabus and course outcomes below.
              </p>
              <div className="flex flex-wrap gap-3">
                <Link
                  href="/images/programs/mba/MBA%20Course%20Structure%20%26%20Syllabus.pdf"
                  target="_blank"
            ...
            <MBASection id="academic-calendar" title="Academic Calendar">
              <p className="text-gray-600 dark:text-gray-300 mb-4">
            ...
            <MBASection id="laboratories" title="Laboratories">
              <div className="grid md:grid-cols-2 gap-4">
                {labs.map((lab) => (
            ...
            <MBASection id="industry-lab" title="Industry Sponsored Laboratory">
            ...
            <MBASection id="mous" title="Memoranda of Understanding (MoUs)">
              <div className="flex flex-wrap gap-3">
            ...
            <MBASection id="innovative-teaching" title="Innovative Teaching Methodologies">
            ...
            <MBASection id="professional-development" title="Professional Development Activities">
            ...
            <MBASection id="photo-gallery" title="Photo Gallery">
...
type MBASectionProps = {
  id: string;
  title: string;
  children: ReactNode;
};

function MBASection({ id, title, children }: MBASectionProps) {
  return (
    <section
      id={id}
