...
const sidebarLinks = [
  { id: 'mechanical-home', label: 'Mechanical Home' },
...
const heroHighlights = [
  ...
  'Experiential learning through labs & projects',
...
const learningOutcomes = [
  'Proficiency in mechanical system design and analysis',
  'Understanding of manufacturing and automation',
  'Ability to use CAD/CAM tools',
  'Problem-solving skills for real-world mechanical challenges',
];
...
const industryLabs = [
  { name: 'Siemens Mechatronics Lab', focus: 'Automation and robotics' },
  { name: 'Bosch Innovation Lab', focus: 'Advanced manufacturing and design' },
];

const peos = [
  'PEO1: Technical Excellence — Apply strong foundational and advanced knowledge in mechanical engineering to solve complex engineering problems.',
  'PEO2: Professional Success — Build successful careers as engineers, team members, or leaders in mechanical and related industries.',
...
const psos = [
  'PSO1: Design and analyze mechanical systems and processes.',
  'PSO2: Develop automation and manufacturing solutions for real-world applications.',
];
...
const innovativePractices = [
  ...
  'Hands-on workshops in CAD/CAM and robotics.',
...
const professionalDevelopmentHighlights = [
  {
    ...
    detail: 'Annual FDPs on CAD/CAM, robotics, and manufacturing with industry experts.',
  },
  {
...
const photoGallery = [
  {
    ...
    description: 'Mechanical faculty prototyping automation tools with industry mentors.',
  },
  {
    src: '/images/programs/mechanical/StudentInnovationShowcasemech.jpeg',
    title: 'Student Innovation Showcase',
    description: 'Mechanical teams demo capstone prototypes and automation dashboards to reviewers.',
  },
  {
    src: '/images/programs/mechanical/ImmersiveLabPracticemech.jpeg',
    title: 'Immersive Lab Practice',
    description: 'Students collaborate in the Siemens Mechatronics Lab.',
  },
  {
...
const academicCalendars = [
  {
    ...
    file: '/images/programs/mechanical/31AcademicCalendar.pdf',
  },
  {
    label: '2nd Year 1st Semester',
    file: '/images/programs/mechanical/21AcademicCalendar.pdf',
  },
];
      ...
      <div className="mx-auto w-full max-w-[95rem] px-4 sm:px-6 lg:px-8 pt-16 pb-12 space-y-12 md:pt-20">
        <header className="relative overflow-hidden rounded-[40px] bg-gradient-to-br from-corporate-navy via-corporate-blue to-sky-400 px-8 py-12 text-white shadow-[0_35px_80px_-40px_rgba(15,23,42,0.9)]">
          ...
          <div className="relative z-10 flex flex-col gap-10 lg:flex-row lg:items-center">
            <div className="flex-1 space-y-6">
              <div>
                <p className="uppercase tracking-[0.4em] text-[11px] text-white/70">Department of Mechanical</p>
                <h1 className="text-[2rem] md:text-[2.75rem] font-black mt-3 drop-shadow-lg">Mechanical Engineering</h1>
                <p className="text-lg text-white/90 mt-4">Designing and innovating the machines of the future</p>
              </div>
              <p className="text-white/85 max-w-2xl leading-relaxed">
                Future-ready curriculum, outcome-based learning, and partnerships with leading technology companies empower NSRIET Mechanical students to
                innovate confidently and lead the next wave of engineering transformation.
              </p>
        ...
        <div className="flex flex-col lg:flex-row gap-10 items-start">
          ...
          <div className="flex-1 w-full space-y-12">
            <MechSection id="mechanical-home" title="Program Overview">
              <div className="space-y-5 text-gray-600 dark:text-gray-300">
                <p>
                  The Mechanical Engineering program at NSRIET is designed to develop skilled professionals who can solve
                  real-world mechanical and automation problems. Students gain expertise in system design, manufacturing, and robotics while
            ...
            <MechSection id="vision-mission" title="Vision &amp; Mission">
              <div className="grid md:grid-cols-2 gap-6">
                <div className="p-6 rounded-2xl bg-blue-50 dark:bg-blue-900/30">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    To develop students as skilled mechanical professionals ready to excel in industry, research, and contribute meaningfully to society.
                  </p>
                </div>
                <div className="p-6 rounded-2xl bg-blue-50 dark:bg-blue-900/30">
                  ...
                  <ul className="space-y-2 text-gray-600 dark:text-gray-300 list-disc list-inside">
                    <li>
                      ...
                      Provide comprehensive knowledge in mechanical fundamentals and advanced concepts through effective teaching methods, with strong emphasis on practical skills.
                    </li>
                    <li>
            ...
            <MechSection id="peos" title="Program Educational Objectives (PEOs)">
            ...
            <MechSection id="pos-psos" title="Program Outcomes (POs) &amp; PSOs">
            ...
            <MechSection id="curriculum" title="Curriculum Highlights &amp; Syllabi">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                Outcome-based curriculum covering core mechanical, emerging tech electives, and interdisciplinary pathways. Download the detailed syllabus and course outcomes below.
              </p>
              <div className="flex flex-wrap gap-3">
                <Link
                  href="/images/programs/mechanical/Mechanical%20Course%20Structure%20%26%20Syllabus-%20B.Tech%20Mech.pdf"
                  target="_blank"
            ...
            <MechSection id="academic-calendar" title="Academic Calendar">
              <p className="text-gray-600 dark:text-gray-300 mb-4">
            ...
            <MechSection id="laboratories" title="Laboratories">
              <div className="grid md:grid-cols-2 gap-4">
                {labs.map((lab) => (
            ...
            <MechSection id="industry-lab" title="Industry Sponsored Laboratory">
            ...
            <MechSection id="mous" title="Memoranda of Understanding (MoUs)">
              <div className="flex flex-wrap gap-3">
            ...
            <MechSection id="innovative-teaching" title="Innovative Teaching Methodologies">
            ...
            <MechSection id="professional-development" title="Professional Development Activities">
            ...
            <MechSection id="photo-gallery" title="Photo Gallery">
...
type MechSectionProps = {
  id: string;
  title: string;
  children: ReactNode;
};

function MechSection({ id, title, children }: MechSectionProps) {
  return (
    <section
      id={id}
