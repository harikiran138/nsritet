...
// --- CSE-AIML department page, full working template ---
...
const learningOutcomes = [
  'Proficiency in AI/ML algorithms and frameworks',
  'Ability to build and deploy intelligent systems',
...
const industryLabs = [
  { name: 'Microsoft AI Garage', focus: 'Applied AI and ML projects' },
  { name: 'AWS DeepRacer Lab', focus: 'Autonomous driving & ML workflows' },
];

const peos = [
  'PEO1: Technical Excellence — Apply advanced knowledge in AI and ML to solve complex engineering problems.',
  'PEO2: Professional Success — Build successful careers as AI/ML engineers, team members, or leaders in tech industries.',
  'PEO3: Lifelong Learning — Engage in continuous self-learning and pursue higher education or certifications in AI/ML.',
];
...
const psos = [
  'PSO1: Design and implement AI/ML models and solutions.',
  'PSO2: Develop scalable data-driven applications for real-world problems.',
];
...
const innovativePractices = [
  ...
  'Hackathons and AI/ML competitions.',
...
const professionalDevelopmentHighlights = [
  {
    ...
    detail: 'Annual FDPs on AI/ML, cloud, and data science with industry experts.',
  },
  {
    title: 'Industry Design Sprints',
    detail: 'Immersive sprints where students build AI prototypes for partner companies.',
  },
  {
    title: 'Innovation Showcases',
    detail: 'Showcases featuring student AI/ML projects, patent pitches, and industry feedback.',
  },
  {
...
const photoGallery = [
  {
    ...
    description: 'CSE-AIML faculty prototyping AI classroom tools with industry mentors.',
  },
  {
    src: '/images/programs/cse-aiml/StudentInnovationShowcaseaiml.jpeg',
    title: 'Student Innovation Showcase',
    description: 'CSE-AIML teams demo capstone AI/ML prototypes to reviewers.',
  },
  {
    src: '/images/programs/cse-aiml/ImmersiveLabPracticeaiml.jpeg',
    title: 'Immersive Lab Practice',
    description: 'Students collaborate in the Microsoft AI Garage.',
  },
  {
...
const academicCalendars = [
  {
    ...
    file: '/images/programs/cse-aiml/31AcademicCalendar.pdf',
  },
  {
    label: '2nd Year 1st Semester',
    file: '/images/programs/cse-aiml/21AcademicCalendar.pdf',
  },
];
      ...
      <div className="mx-auto w-full max-w-[95rem] px-4 sm:px-6 lg:px-8 pt-16 pb-12 space-y-12 md:pt-20">
        <header className="relative overflow-hidden rounded-[40px] bg-gradient-to-br from-corporate-navy via-corporate-blue to-sky-400 px-8 py-12 text-white shadow-[0_35px_80px_-40px_rgba(15,23,42,0.9)]">
          ...
          <div className="relative z-10 flex flex-col gap-10 lg:flex-row lg:items-center">
            <div className="flex-1 space-y-6">
              <div>
                <p className="uppercase tracking-[0.4em] text-[11px] text-white/70">Department of CSE-AIML</p>
                <h1 className="text-[2rem] md:text-[2.75rem] font-black mt-3 drop-shadow-lg">CSE - Artificial Intelligence &amp; Machine Learning</h1>
                <p className="text-lg text-white/90 mt-4">Specializing in the most in-demand technology of tomorrow</p>
              </div>
              <p className="text-white/85 max-w-2xl leading-relaxed">
                Future-ready curriculum, outcome-based learning, and partnerships with leading technology companies empower NSRIET CSE-AIML students to
        ...
        <div className="flex flex-col lg:flex-row gap-10 items-start">
          ...
          <div className="flex-1 w-full space-y-12">
            <AIMLSection id="cse-aiml-home" title="Program Overview">
              <div className="space-y-5 text-gray-600 dark:text-gray-300">
                <p>
                  The CSE-AIML program at NSRIET is designed to develop skilled professionals who can solve
                  real-world AI and ML problems. Students gain expertise in machine learning, deep learning, and data science while
            ...
            <AIMLSection id="vision-mission" title="Vision &amp; Mission">
              <div className="grid md:grid-cols-2 gap-6">
                <div className="p-6 rounded-2xl bg-blue-50 dark:bg-blue-900/30">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    To develop students as skilled AI/ML professionals ready to excel in industry, research, and contribute meaningfully to society.
                  </p>
                </div>
                <div className="p-6 rounded-2xl bg-blue-50 dark:bg-blue-900/30">
                  ...
                  <ul className="space-y-2 text-gray-600 dark:text-gray-300 list-disc list-inside">
                    <li>
                      ...
                      Provide comprehensive knowledge in AI/ML fundamentals and advanced concepts through effective teaching methods, with strong emphasis on practical skills.
                    </li>
                    <li>
            ...
            <AIMLSection id="peos" title="Program Educational Objectives (PEOs)">
            ...
            <AIMLSection id="pos-psos" title="Program Outcomes (POs) &amp; PSOs">
            ...
            <AIMLSection id="curriculum" title="Curriculum Highlights &amp; Syllabi">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                Outcome-based curriculum covering core AI/ML, emerging tech electives, and interdisciplinary pathways. Download the detailed syllabus and course outcomes below.
              </p>
              <div className="flex flex-wrap gap-3">
                <Link
                  href="/images/programs/cse-aiml/CSE-AIML%20Course%20Structure%20%26%20Syllabus.pdf"
                  target="_blank"
            ...
            <AIMLSection id="academic-calendar" title="Academic Calendar">
              <p className="text-gray-600 dark:text-gray-300 mb-4">
            ...
            <AIMLSection id="laboratories" title="Laboratories">
              <div className="grid md:grid-cols-2 gap-4">
                {labs.map((lab) => (
            ...
            <AIMLSection id="industry-lab" title="Industry Sponsored Laboratory">
            ...
            <AIMLSection id="mous" title="Memoranda of Understanding (MoUs)">
              <div className="flex flex-wrap gap-3">
            ...
            <AIMLSection id="innovative-teaching" title="Innovative Teaching Methodologies">
            ...
            <AIMLSection id="professional-development" title="Professional Development Activities">
            ...
            <AIMLSection id="photo-gallery" title="Photo Gallery">
...
type AIMLSectionProps = {
  id: string;
  title: string;
  children: ReactNode;
};

function AIMLSection({ id, title, children }: AIMLSectionProps) {
  return (
    <section
      id={id}
