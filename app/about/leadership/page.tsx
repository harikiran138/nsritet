      ...
      sections={[
        {
          ...
          description: 'Meet the key leaders guiding the institution',
        ...
        },
        {
          ...
          description: 'Our approach to institutional governance',
            ...
            <div className="space-y-6">
              <div className="grid md:grid-cols-3 gap-4">
                {[
                  {
                    title: 'Excellence',
                    desc: 'Commitment to highest standards in academics, research, and administration'
                  },
                  {
                    title: 'Inclusivity',
                    desc: 'Creating an environment where every student and faculty member can thrive'
                  },
                  {
                    title: 'Innovation',
                    desc: 'Fostering creative thinking and continuous improvement across all areas'
                  },
                  {
                    title: 'Integrity',
                    desc: 'Operating with transparency and ethical conduct in all decisions'
                  },
                  {
                    title: 'Collaboration',
                    desc: 'Building strong partnerships with industry, academia, and society'
                  },
                  {
                    title: 'Accountability',
                    desc: 'Taking responsibility for institutional outcomes and student success'
                  },
                ].map((value, idx) => (
        ...
        },
        {
          ...
          description: 'Reach out to leadership',
