      ...
      sections={[
        {
          ...
          description: 'Developing industry-ready skills for career success',
        ...
        },
        {
          ...
          description: 'Diverse skill development areas',
        ...
        },
        {
          ...
          description: 'How training programs are conducted',
